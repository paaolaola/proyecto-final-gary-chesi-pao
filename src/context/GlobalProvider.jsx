...
const GlobalProvider = ({ children }) => {
	...
	// Efecto para recuperar el usuario al montar el componente
	useEffect(() => {
		// Obtener el usuario del sessionStorage
		const storedUser = sessionStorage.getItem("currentUser");

		// Si hay un usuario almacenado, parsearlo y establecerlo en el estado
		if (storedUser) {
	...
	useEffect(() => {
		// Convertir el objeto del usuario a cadena JSON
		const userString = JSON.stringify(currentUser);

		// Almacenar la cadena JSON en el sessionStorage
